...
RETURNING id, email, display_name, avatar_url, google_sub, oidc_sub, password_hash, is_admin, created_at
`
...
SELECT id, email, display_name, avatar_url, google_sub, oidc_sub, password_hash, is_admin, created_at FROM users WHERE email = $1
`
...
SELECT id, email, display_name, avatar_url, google_sub, oidc_sub, password_hash, is_admin, created_at FROM users WHERE google_sub = $1
`
...
SELECT id, email, display_name, avatar_url, google_sub, oidc_sub, password_hash, is_admin, created_at FROM users WHERE id = $1
`
...
SELECT id, email, display_name, avatar_url, google_sub, oidc_sub, password_hash, is_admin, created_at FROM users WHERE oidc_sub = $1
`
