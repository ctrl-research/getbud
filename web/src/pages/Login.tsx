...
export function LoginPage() {
  ...
  return (
    <div className="mx-auto mt-24 w-full max-w-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm">
      <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Sign in to getbud</h1>
      ...
      <div className="mt-6 space-y-4">
        ...
        {providers && providers.length === 0 && (
          <p className="text-sm text-amber-700 dark:text-amber-300">
            No sign-in methods are configured. Set <code>GETBUD_GOOGLE_CLIENT_ID</code>/
            <code>SECRET</code>, <code>GETBUD_OIDC_*</code>, or{' '}
            <code>GETBUD_LOCAL_AUTH=true</code> on the server.
          </p>
        )}
      </div>
    </div>
